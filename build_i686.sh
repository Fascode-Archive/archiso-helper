...
# Update mirrorlist
update_mirror() {
    rm ./work/airootfs/etc/pacman.d/mirrorlist
    wget -O ./work/airootfs/etc/pacman.d/mirrorlist https://git.archlinux32.org/archlinux32/packages/raw/branch/master/core/pacman-mirrorlist/mirrorlist
    sed -i "s/#Server/Server/g" ./work/airootfs/etc/pacman.d/mirrorlist
}
